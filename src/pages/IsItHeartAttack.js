...
const IsItHeartAttack = () => {
    ...
    console.log("Routed from ", location.state.title);
    console.log("Total Number of Screens", location.state.totalScreens);
    ...
    return (
        <>
            ...
            <div class="bottom-fixed-div">
                ...
                <button className='buttonMix' onClick={()=>{history.push('/Questions', {title:location.state.title, totalScreens: location.state.totalScreens })}}>Agree</button>
            </div>
        </>
...
export default IsItHeartAttack